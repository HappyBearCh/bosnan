...
module.exports = [
  ...
  {
    id: 'myst-prima-official-strategy-guide',
    title: 'Myst: Prima\'s Official Strategy Guide',
    game: 'Myst',
    publisher: 'Prima',
    year: 1994,
    author: 'Rick Barba and Rusel DeMaria',
    era: '1990s',
    description: 'Prima\'s Myst guide sold over 1.25 million copies — the company\'s first bestseller and proof that a strategy guide could reach an audience far beyond the people who normally bought games.',
    ...
    notableFor: 'The best-selling strategy guide of the pre-internet era, sold largely to an audience who owned exactly one game and could not finish it.',
    sections: [
      {
        title: 'A Guide for People Who Did Not Buy Games',
        html: '<p>The commercial logic of most strategy guides is straightforward: a fraction of a game\'s players get stuck or want completion, and some fraction of those will pay for help. Myst broke the model because its audience was not made of gamers. It sold to households that owned a CD-ROM drive and very little to put in it, to adults who had never finished a video game and had no framework for what being stuck even meant. When those players hit the Selenitic Age and stopped, they did not consult a friend or a magazine — they went to a bookstore.</p><p>That is how a strategy guide sells 1.25 million copies. The figure is not a measure of Myst\'s difficulty so much as of its reach into a population with no other recourse. Prima had stumbled into a readership that treated a game guide as an ordinary book purchase, and the sales reflected book-market economics rather than games-market ones.</p>',
      },
      {
        title: 'Solving Without Spoiling',
        html: '<p>Myst\'s entire value proposition was the feeling of being alone on an island with no one to tell you anything. A guide is, structurally, someone telling you things — which meant Barba and DeMaria were writing a book whose straightforward execution would ruin its subject. Their answer was to fictionalise the walkthrough, narrating a traversal of the island as an experience rather than issuing a numbered list of actions, so that a reader could take the smallest possible dose of help without collapsing the mystery entirely.</p><p>The revised 1995 edition pushed further in the same direction by adding an interview with Rand and Robyn Miller, turning the book into something closer to a companion volume than a solution manual — a thing you might read after finishing rather than only when stuck. This positioning was unusual for the format and well matched to an audience that regarded Myst as an artwork they had failed to understand rather than a game they had failed to beat.</p>',
      },
    ],
  },
  {
    id: 'mario-mania-players-guide',
    title: 'Mario Mania Player\'s Guide',
    game: 'Super Mario World',
    publisher: 'Nintendo',
    year: 1991,
    author: 'Nintendo Power staff',
    era: '1990s',
    description: 'Mario Mania was the first official Nintendo Player\'s Guide devoted to a single game, pairing full Super Mario World coverage with a retrospective on Mario\'s entire career — a guide that doubled as the franchise\'s first history book.',
    ...
    notableFor: 'The first single-game Nintendo Player\'s Guide, and an early example of a strategy guide doubling as franchise history.',
    sections: [
      {
        title: 'The Pack-In Guarantees the Audience',
        html: '<p>A dedicated guide to a single game is a bet that enough people will own that specific game to justify the print run. Super Mario World removed the bet entirely. As the North American SNES pack-in from August 1991, it was in the box of every console sold — no purchasing decision, no market segment, just a one-to-one relationship between SNES owners and Super Mario World players. Nintendo knew the size of its potential readership precisely, because it was the size of its install base.</p><p>That certainty is what made a single-game Player\'s Guide viable when previous volumes had hedged by covering several titles at once. It also explains the guide\'s ambition: with the audience guaranteed, the question shifted from whether to publish to how much could be justified, and the answer turned out to be a full accounting of ninety-six exits, the secret routes, Star Road, and the Special World.</p>',
      },
      {
        title: 'History Alongside the Walkthrough',
        html: '<p>The decision that gives Mario Mania its lasting reputation was including a retrospective on Mario\'s career — where the character came from, what he had appeared in, how the games had developed. This was not strategy content and it did not help anyone find a secret exit. It was context, and it reframed what a Player\'s Guide could be: not a manual to be consulted while stuck and discarded when finished, but a volume about a series that happened to also contain a walkthrough.</p><p>For a readership largely composed of children encountering a fifteen-year-old company\'s flagship character on brand-new hardware, this material did real work. It established that Mario had a past worth knowing about, and it positioned Nintendo Power as the institution that knew it. The commercial logic was the same as the magazine\'s: information as a relationship rather than a transaction. Guides that were kept, reread, and pinned to walls did more for Nintendo than guides that answered a question and were thrown away.</p>',
      },
    ],
  },
  {
    ...
    year: 1998,
    author: 'Casey Loe and staff',
    era: '1990s – 2000s',
    description: 'Versus Books was founded when a GameFan editor pitched a strategy guide line, was refused a cut of the profits, and quit to build it himself — producing "Perfect Guides" that enthusiasts rated above the official competition.',
    ...
    notableFor: 'An enthusiast-run guide publisher born from a refused profit share, whose "Perfect Guides" are still rated above the industrial competition.',
    sections: [
      {
        title: 'Born From a Refused Cut',
        html: '<p>The founding story is worth dwelling on because it explains the product. Matthew Taylor was inside GameFan when he identified that strategy guides were a business the magazine could enter; his employers agreed the idea had merit but not that he should share in the proceeds. He left. What Versus Books then produced was, in effect, what the guide line would have been had it stayed in-house — made by magazine people, with a magazine\'s eye for layout and a magazine\'s assumption that the reader is an enthusiast rather than a customer to be processed.</p><p>That inheritance is visible on the page. GameFan was known for lavish design and genuine passion, particularly for Japanese releases that the mainstream American press covered thinly, and the Versus guides carry the same density and the same presumption of interest. They were not written for someone stuck on a boss; they were written for someone who wanted to know everything.</p>',
      },
      {
        title: 'Perfect Guides Against the Machine',
        html: '<p>Prima and BradyGames operated at scale, with the throughput required to have an official guide on shelves on a game\'s release day, every time. That model produces reliable books and imposes a ceiling on how deep any one of them can go. Versus Books competed by inverting the priorities — fewer titles, more thoroughness, better design — and by picking the games where thoroughness mattered most: sprawling RPGs, Zelda entries, Pokémon, Shenmue, imports with obsessive followings.</p><p>The strategy worked well enough that "Versus Books" still carries weight in collector circles decades later, and Casey Loe is spoken of as the best writer the format produced. It is a small vindication of an unglamorous principle: in a market where every competitor ships an adequate product on time, the way to be remembered is to ship a better one. The guides outlasted the era that made them necessary, which is more than most of their industrial rivals managed.</p>',
      },
    ],
  },
];
