...
module.exports = [
  ...
  {
    id: 'super-mario-128-spaceworld-2000',
    title: 'Super Mario 128 — The Demo That Became Four Other Games',
    game: 'Super Mario 128',
    platform: 'Nintendo GameCube',
    buildDate: 'August 2000',
    discoveredYear: 2000,
    source: 'Public Trade Show Demo',
    era: '2000s',
    description: 'Shown at Nintendo Space World 2000, Super Mario 128 put 128 Marios on screen at once and was never released as a game. Its ideas ended up scattered across Pikmin, Metroid Prime, Twilight Princess and Super Mario Galaxy.',
    ...
    differences: [
      'Was never a game — it was a GameCube hardware demonstration that the press persistently reported as a Mario sequel',
      '128 Marios were simulated simultaneously, a headline number chosen to contrast with N64-era character counts',
      'The demo let the Marios deform and reshape the terrain they stood on, including folding the platform into a pizza',
      'The name had already been used in 1997 for a separate, cancelled 64DD sequel to Super Mario 64',
      'No playable build has ever surfaced; the demo exists publicly only as trade-show footage',
      'Miyamoto confirmed the cancellation in 2006, six years after the initial showing',
    ],
    keyFacts: [
      'Demonstrated at Nintendo Space World in August 2000 as a GameCube technical showcase, not a product',
      'Miyamoto stated at GDC 2007 that its group-AI work became Pikmin and its sphere-walking became Super Mario Galaxy',
      'Elements were also folded into Metroid Prime and The Legend of Zelda: Twilight Princess',
      'The "Super Mario 128" name was first used in 1997 for an unrelated, also-cancelled 64DD project',
    ],
    sections: [
      {
        title: 'A Demo Mistaken for a Promise',
        html: '<p>The confusion was structural. Nintendo needed to prove the GameCube could handle vastly more simultaneous simulation than the N64, and the most legible way to prove that to a room full of journalists was to fill the screen with a character everyone recognised. But putting Mario in a tech demo, in 2000, and calling it Super Mario 128 was effectively announcing a game — regardless of what was said from the podium.</p><p>For the next six years, every Nintendo press event carried the question. Preview sections listed it. Rumour columns speculated about its engine. The gap between what Nintendo had shown and what the audience believed it had been shown widened until the demo had acquired an entirely fictional second life as a delayed, troubled, endlessly-rumoured Mario sequel that had never existed in the first place.</p>',
      },
      {
        title: 'Where It Actually Went',
        html: '<p>Miyamoto\'s GDC 2007 keynote reframed the whole saga. Super Mario 128 was not a game that failed; it was research that succeeded, and whose results were harvested into other products. The problem of making 128 autonomous agents behave as a coherent, commandable crowd is, in the end, the problem of Pikmin — and Pikmin shipped in 2001, a year after the demo. The problem of keeping a character correctly oriented while walking around the outside of a curved surface is the problem of Super Mario Galaxy, which shipped in 2007.</p><p>Read that way, the demo is one of the most productive pieces of unreleased software in Nintendo\'s history. It never became a Mario game, but it is a load-bearing ancestor of at least four shipped titles across two console generations. The vapourware everyone was waiting for had already been delivered — just under different names.</p>',
      },
    ],
  },
  {
    id: 'ura-zelda-64dd',
    title: 'Ura Zelda — The 64DD Expansion That Became Master Quest',
    game: 'The Legend of Zelda: Ocarina of Time',
    platform: 'Nintendo 64DD',
    buildDate: '1999–2000',
    discoveredYear: 2002,
    source: 'Cancelled Retail Product',
    era: '1990s',
    description: 'A disk-based expansion that would have rebuilt Ocarina of Time\'s dungeons while the original cartridge sat plugged into the console above it. The 64DD died, and Ura Zelda became a bonus disc.',
    ...
    differences: [
      'Every dungeon was to be rebuilt with rearranged rooms, relocated items and harder enemy placements',
      'Ran as a patch: the retail Ocarina of Time cartridge stayed in the N64 while the disk supplied the changes',
      'Additional areas were planned, including the long-rumoured Unicorn Fountain that was cut from the original game',
      'Cancelled outright when the 64DD failed commercially, despite being near completion',
      'Resurfaced in 2002 as Master Quest on a GameCube bonus disc packaged with The Wind Waker',
      'Master Quest\'s ROM is the same size as standard Ocarina of Time, casting doubt on whether it is the full Ura Zelda',
    ],
    keyFacts: [
      'The 64DD\'s pass-through architecture allowed a disk to patch a cartridge already in the console',
      'Ura Zelda was reportedly near completion when the 64DD\'s commercial failure killed it',
      'Master Quest shipped in 2002 on a GameCube bonus disc bundled with The Wind Waker',
      'Fans continue to dispute whether Master Quest represents the whole of the Ura Zelda project or only its dungeon remix',
    ],
    sections: [
      {
        title: 'The Expansion Disk Before Expansions Existed',
        html: '<p>What Ura Zelda proposed in 1999 is now completely ordinary and was then almost unheard of: buy a game, then later buy an add-on that reaches into it and changes its content without replacing it. The 64DD\'s hardware made it technically natural — the drive sat under the console and could read the cartridge above — and Nintendo clearly saw the model\'s potential, since Ura Zelda was designed around it rather than merely ported to it.</p><p>The idea was sound and the platform was not. The 64DD launched in Japan only, in December 1999, through a subscription service, into a market already looking at the PlayStation and the coming Dreamcast. It sold catastrophically. Ura Zelda was a well-built expansion for a machine almost nobody owned, and no amount of finished code could fix that.</p>',
      },
      {
        title: 'Is Master Quest Really Ura Zelda?',
        html: '<p>The salvage operation produced something real: Master Quest is a genuine remix of Ocarina of Time, with dungeons rebuilt to be considerably harder, and it reached far more players on a GameCube bonus disc than it ever would have on a 64DD disk. For most purposes, the story ends there — the content survived, the platform did not.</p><p>But the sceptics have a point that has never been fully answered. The entire rationale for building Ura Zelda on the 64DD was that a disk could hold more than a cartridge; yet Master Quest\'s ROM measures the same size as the original Ocarina of Time. If Ura Zelda was genuinely a content expansion, something is missing. If it was only ever a dungeon remix, then it did not need the 64DD at all. Nintendo has never resolved the discrepancy, which is why "what was Ura Zelda actually going to be" remains one of the more durable open questions in the series\' history.</p>',
      },
    ],
  },
  {
    id: 'resident-evil-4-hookman',
    title: 'Resident Evil 4 "Hookman" — The Ghost Build',
    game: 'Resident Evil 4',
    platform: 'Nintendo GameCube',
    buildDate: '2003',
    discoveredYear: 2003,
    source: 'E3 Demo Footage',
    era: '2000s',
    description: 'Before Resident Evil 4 became the game that redefined the third-person shooter, it was a supernatural horror story in which an infected Leon hallucinated a hook-armed ghost climbing out of a painting.',
    ...
    differences: [
      'Leon was infected with a hallucinogenic virus; the enemies were psychological, not biological',
      'Enemies included a hook-armed ghost emerging from a painting and animated dolls — overtly supernatural, unlike the final game',
      'Set largely in a haunted mansion-style environment rather than a rural European village',
      'Retained a more traditional survival-horror framing rather than the over-the-shoulder action design of the released version',
      'Would have required a real and a hallucinated version of every stage — the cost that killed it',
      'Abandoned in autumn 2003 and replaced by the "Zombie" build, which became the final Resident Evil 4',
    ],
    keyFacts: [
      'Internally called "Hallucination"; the fan name "Hookman" comes from the hook-armed enemy in the E3 2003 demo',
      'It was the third distinct attempt at Resident Evil 4 — an earlier version had already become Devil May Cry',
      'Killed by the cost of building two versions of every stage, one real and one hallucinated',
      'Director Hiroshi Shibata ended the build in autumn 2003, pivoting to the version that eventually shipped in 2005',
    ],
    sections: [
      {
        title: 'The Cost of a Good Idea',
        html: '<p>The Hookman build failed for a reason that has nothing to do with quality. Its central conceit — that the player cannot trust what Leon is seeing — is dramatically excellent and structurally ruinous. To make a hallucination land, the player must be able to compare it against reality, which means the reality has to exist too. Every corridor, every room, every set of props needed a sane version and an insane version, doubling the art budget for a game that was already Capcom\'s most expensive.</p><p>On 2003 hardware that was not a tuning problem, it was a wall. The GameCube could not hold two parallel dressings of an environment at the fidelity the concept demanded, and no amount of scoping down would preserve what made the idea worth doing. Capcom did the expensive, correct thing: it threw away years of work rather than ship a diluted version of a concept that only worked at full strength.</p>',
      },
      {
        title: 'What Was Lost and What Was Gained',
        html: '<p>The trade is hard to argue with. What replaced Hookman was Resident Evil 4 as released in 2005 — the over-the-shoulder camera, the contextual melee, the pacing that made a shooter out of a horror franchise, and a design vocabulary that the next decade of third-person action games simply adopted wholesale. Gears of War, Dead Space, The Last of Us and countless others descend from the game Capcom got by abandoning Hookman.</p><p>Yet the ghost build retains an unusual hold on the series\' fanbase, precisely because it is the road not taken toward a Resident Evil that stayed frightening rather than becoming thrilling. Its supernatural bestiary — the doll, the hook, the shifting hallway — has never been reused, and Capcom has left it alone. It sits in the archive as the most interesting thing the series ever decided not to be.</p>',
      },
    ],
  },
  {
    id: 'pokemon-gold-silver-spaceworld-97',
    title: 'Pokémon Gold & Silver — The Spaceworld \'97 Demo',
    game: 'Pokémon Gold and Silver',
    platform: 'Game Boy',
    buildDate: 'November 1997',
    discoveredYear: 2018,
    source: 'Leaked Online',
    era: '1990s',
    description: 'A playable build shown at Nintendo Space World in November 1997 and leaked twenty-one years later, containing dozens of Pokémon that were redesigned, reslotted or cut before the games shipped.',
    longDescription: 'Nintendo Space World ran from 21 to 23 November 1997, and the Pokémon Gold and Silver shown there was not the Pokémon Gold and Silver that reached players two years later. The demo is an early build in an unfinished state: much of the overworld outside the towns is incomplete, no new music had been written so the soundtrack is lifted wholesale from Red and Blue, and the roster of new Pokémon was still in flux to a degree that is startling in hindsight. Of the three starters on offer, only Chikorita survived to the final game. Dozens of other creatures appear in different evolutionary positions, with different typings, or in designs that were subsequently abandoned outright. For two decades this was known only through photographs of the show floor and the recollections of people who had queued to play it, which made it a standing subject of speculation. Then, on 26 May 2018, an anonymous user posted ROMs of the demos online. The provenance was unclear at the time and was later traced to the 2018 Nintendo data breach carried out by the hacker Zammis Clark — the same intrusion that produced a long series of Nintendo internal leaks over the following years. What made this one exceptional was that the material was complete and playable rather than fragmentary. Generation II\'s development had been unusually long and unusually opaque, and the Spaceworld build is the only substantial window into it: designs previously visible as a handful of blurry pixels turned out to exist as finished sprites, sitting in a ROM alongside the versions that replaced them.',
    differences: [
      'Only Chikorita of the three starter Pokémon survived unchanged into the final games',
      'Dozens of new Pokémon appear with different types, in different evolutionary slots, or in designs later abandoned',
      'No new music had been composed — the build reuses the soundtrack of Pokémon Red and Blue',
      'The overworld outside the towns is largely unfinished',
      'The build predates a substantial redesign of the new Pokémon roster',
    ],
    keyFacts: [
      'Shown publicly at Nintendo Space World from 21 to 23 November 1997, roughly two years before the games shipped',
      'ROMs of the demo appeared online on 26 May 2018',
      'The dump originated in the 2018 Nintendo data breach carried out by the hacker Zammis Clark',
      'It is the most substantial surviving record of how Generation II was designed',
      'Designs known previously only from show-floor photographs turned out to exist as finished sprites',
    ],
    sections: [
      {
        title: 'Why an Unfinished Build Matters More Than a Finished One',
        html: '<p>A shipped game tells you what a studio decided. A build like this one tells you what it was choosing between, which is the harder thing to reconstruct and the more informative. Generation II is remembered as the point at which Pokémon consolidated — day and night cycles, breeding, a second region bolted onto the first — and the Spaceworld demo shows that consolidation was not the plan so much as the result of a long process of discarding.</p><p>The starters make the point economically. Two of the three shown in 1997 did not survive, and the survivor, Chikorita, is the one that looks least like an escalation of the Red and Blue formula. Whatever was being pursued in 1997 was pulled back toward familiarity before release — a decision that is invisible in the shipped game and obvious in the demo.</p>',
      },
      {
        title: 'A Leak With an Unusual Provenance',
        html: '<p>Most prototype recoveries come from the same handful of routes: a developer keeps a cartridge, a warehouse is cleared, a review copy surfaces at auction. This one came from a network intrusion, and that changes what the material is. The Spaceworld demo did not survive because somebody preserved it; it survived because it was sitting on an internal server and somebody took the server.</p><p>That makes it a preservation windfall and an uncomfortable one. The community that had spent twenty years assembling Generation II\'s development history from photographs got, in a single day, more primary material than two decades of careful work had produced — and got it by no effort or merit of its own. The archival value is real. So is the fact that nobody involved in creating the material agreed to release it.</p>',
      },
    ],
    sources: [
      {
        title: 'Proto:Pokémon Gold and Silver/Spaceworld 1997 Demo',
        publisher: 'The Cutting Room Floor',
        url: 'https://tcrf.net/Proto:Pok%C3%A9mon_Gold_and_Silver/Spaceworld_1997_Demo',
      },
      {
        title: 'Pokémon Gold & Silver (Spaceworld 1997 Demo)',
        publisher: 'Hidden Palace',
        url: 'https://hiddenpalace.org/Pok%C3%A9mon_Gold_&_Silver_(Spaceworld_1997_Demo)',
      },
    ],
  },
  {
    id: 'half-life-2-2003-leak',
    title: 'Half-Life 2 — The 2003 Leak',
    game: 'Half-Life 2',
    platform: 'PC',
    buildDate: 'September 2003',
    discoveredYear: 2003,
    source: 'Leaked Online',
    era: '2000s',
    description: 'A German programmer broke into Valve\'s network out of curiosity rather than profit, and an unfinished Half-Life 2 escaped onto the internet more than a year before release.',
    longDescription: 'The intrusion was not sophisticated, which is part of what made it so damaging. Axel Gembe, a young German programmer whose favourite game was Half-Life, found that Valve\'s name server permitted anonymous zone transfers — meaning it would simply hand over a list of every subdomain the company operated to anyone who asked. From there he found a domain controller carrying an account named "build" with no password on it. On 19 September 2003 he downloaded the unfinished game. The Source engine source code was posted publicly on 2 October and an incomplete build of the game itself on 7 October, thirteen months before Half-Life 2 shipped. The community name for what circulated — the "Half-Life 2 beta" — is a convenient misnomer. What leaked was not a single coherent build but files spanning years of development, which is why the leak is so revealing and so unplayable at the same time: whole chapters exist in fragments, maps reference assets that were removed at different points, and a great deal of it cannot be assembled into anything that runs end to end. What it does contain is a record of the game Valve was making before it made the one that shipped: a darker, more industrial City 17, and a body of cut material including the Air Exchange and Kraken Base chapters and enemies such as the Hydra and the Combine Guard. Valve\'s response was to ask for help — Gabe Newell posted publicly to the Half-Life community appealing for information about the intruder, an unusual move that worked. Gembe was identified, and the pursuit that followed took an unusual turn: he was reportedly offered a job interview in the United States, an arrangement that would have delivered him to the FBI, before German authorities acted first. He admitted infiltrating Valve — it was never established that he was the one who published the files — and received a two-year probationary sentence.',
    differences: [
      'It is not a single build: the leaked files span several years of development rather than one coherent version',
      'Large amounts of cut content survive, including the Air Exchange and Kraken Base chapters',
      'Enemies that never shipped are present in some form, among them the Hydra and the Combine Guard',
      'City 17 carries a darker, more industrial art direction than the released game',
      'Much of it cannot be played end to end — maps are unfinished and reference assets removed at different stages',
    ],
    keyFacts: [
      'Axel Gembe reached Valve\'s network after finding that its name server permitted anonymous zone transfers',
      'A domain controller account named "build" had a blank password',
      'He downloaded the unfinished game on 19 September 2003',
      'The Source engine code was posted on 2 October 2003 and a playable build on 7 October',
      'Gabe Newell appealed publicly to the Half-Life community for help identifying the intruder',
      'Gembe admitted infiltrating Valve and received a two-year probationary sentence in Germany',
    ],
    sections: [
      {
        title: 'The Beta That Isn\'t',
        html: '<p>Calling the leak a beta implies a snapshot: this is what the game looked like on a given day. It is nothing of the sort. The files were pulled from an internal store that had accumulated work over years, so a map from one period sits beside an entity definition from another and a texture set from a third. Assembling any of it into something playable means reconciling versions that never coexisted in the first place.</p><p>That is exactly why the modding community has spent two decades on it. Projects to restore the leaked chapters are not ports; they are reconstructions, and every one of them has to make judgement calls about which of several incompatible versions of a thing was the intended one. The material documents a process rather than a product, and reading it requires the same care as reading any other incomplete archive.</p>',
      },
      {
        title: 'What Valve Did Next',
        html: '<p>Half-Life 2 slipped to November 2004, and the leak is usually named as the cause. The more precise account is that the game was not close to finished in October 2003 regardless — the leak made that publicly visible at a moment when the schedule had already been communicated as though it were.</p><p>The lasting institutional consequence was different and larger. Steam had launched in September 2003 as an unloved patching utility; Half-Life 2 shipped requiring it, which converted a piece of infrastructure nobody wanted into the distribution platform for an industry. Nothing about that chain of events was caused by Gembe. But the year in which Valve had to think hard about how its software reached players, and about who could reach its software, was the same year the decision got made.</p>',
      },
    ],
    sources: [
      {
        title: 'That Time A German Hacker Leaked Half-Life 2\'s Source Code',
        publisher: 'Kotaku',
        url: 'https://kotaku.com/that-time-a-german-hacker-leaked-half-life-2s-source-co-1737015166',
      },
      {
        title: 'Half-Life 2 leak',
        publisher: 'Combine OverWiki',
        url: 'https://combineoverwiki.net/wiki/Half-Life_2_leak',
      },
    ],
  },
  {
    id: 'nintendo-playstation-snes-cd',
    title: 'The Nintendo PlayStation — SNES-CD Prototype',
    game: 'Super NES CD-ROM System',
    platform: 'Super Nintendo / Sony CD-ROM',
    buildDate: 'c. 1992',
    discoveredYear: 2015,
    source: 'Auction Lot',
    era: '1990s',
    description: 'A small run was built before Nintendo abandoned Sony at CES in 1991. One surfaced in a box won at a bankruptcy auction for $75, and sold in 2020 for $360,000.',
    ...
    sections: [
      {
        title: 'The Deal That Made the Competitor',
        html: '<p>The usual telling of this story treats the CES announcement as an act of corporate cruelty, and it was, but the substance underneath it was a fight about who owned CD-based software on Nintendo hardware. The terms Sony had negotiated would have given it a controlling position in a format Nintendo intended to depend on. Nintendo\'s response was to go to Philips instead and say so in public, which resolved the immediate problem and created a far larger one.</p><p>Sony was left holding a nearly complete piece of hardware, an assembled team, and a specific and recent grievance. Three years later the PlayStation arrived and took the market Nintendo had assumed was permanently its own. It is difficult to name another business decision in the industry whose consequences were both so predictable and so completely unanticipated by the people making it.</p>',
      },
      {
        title: 'How a Prototype Survives',
        html: '<p>Prototypes are not built to last. They are internal tools, and when a project dies the standard fate is a skip or a locked cupboard that is eventually cleared by someone with no idea what is in it. That this unit exists at all is down to a chain of accidents: an executive who took it with him, a bankruptcy that auctioned office contents rather than binning them, and a buyer who paid $75 for a box without knowing what was inside.</p><p>The $360,000 price is the part that gets reported, but the more interesting figure is the $75 — the point at which the object was worth precisely what an unlabelled box of old office equipment is worth. Almost everything that has been lost from this era was lost at exactly that moment, to someone who made the reasonable call rather than the lucky one.</p>',
      },
    ],
    sources: [
      {
        title: 'The Nintendo PlayStation sells for $360,000 at auction',
        publisher: 'Engadget',
        url: 'https://www.engadget.com/2020-03-06-nintendo-playstation-auction-done.html',
      },
      {
        title: 'Nintendo PlayStation: Ultra-rare prototype sells for £230,000',
        publisher: 'BBC News',
        url: 'https://www.bbc.com/news/technology-51628836',
      },
    ],
  },
];
