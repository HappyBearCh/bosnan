...
module.exports = [
  ...
  {
    id: 'ultima-escape-from-mt-drash',
    title: 'Ultima: Escape from Mt. Drash',
    developer: 'Keith Zabalaoui / Sierra On-Line',
    platform: 'Commodore VIC-20',
    year: 1983,
    status: 'Released but nearly lost — the "holy grail" of game collecting',
    description: 'An Ultima game in name only, released on cassette for the VIC-20 in a run of a few thousand copies and never marketed — it vanished so completely that for years collectors doubted it had ever existed.',
    longDescription: 'Ultima: Escape from Mt. Drash is the strangest entry in one of gaming\'s most storied franchises, and for a long time it was the most sought-after object in the entire hobby. Published by Sierra On-Line for the Commodore VIC-20 in 1983, it was written by Keith Zabalaoui — a friend of Richard Garriott who had worked on his earlier games — and it is connected to the Ultima series in name alone. Garriott had no direct involvement in its development.\n\nThe reason it carries the Ultima name is purely commercial. Sierra had published Ultima II, and it named this unrelated maze game an Ultima specifically to improve its sales; Garriott granted permission for the branding as a favour. The game itself is a first-person maze survival title in which the player flees creatures through corridors, bearing no meaningful resemblance to the sprawling role-playing epics that made the series famous.\n\nWhat made it legendary was its disappearance. Unlike most VIC-20 releases, which shipped on cartridges, Escape from Mt. Drash was issued only on cassette, and Sierra produced just a few thousand copies — enough to satisfy a contractual obligation, and then never actively marketed it. The game sank without trace, and for years its existence circulated among Ultima fans as something close to rumour, earning it the title of the "holy grail" of classic game collecting.\n\nIt was not until 2000 that the first copies were confirmed and announced, with the first online auction of a copy taking place in September 2003. Its scarcity has driven prices to extraordinary heights: in November 2017 a still-sealed boxed copy was listed on eBay from a seller in North Canton, Ohio, with a starting bid of $949.95. The auction closed on 10 December 2017 after thirty bids, selling for $9,002 to a collector in Kirkland, Washington. A game nobody wanted in 1983 became, forty years later, one of the most valuable artefacts in the medium.',
    keyFacts: [
      'Published by Sierra On-Line for the VIC-20 in 1983, written by Keith Zabalaoui',
      'An Ultima in name only — Richard Garriott granted the branding purely to help sales',
      'Released only on cassette in a run of a few thousand copies, and never marketed',
      'A sealed copy sold for $9,002 on eBay in December 2017',
    ],
    discoveredBy: 'Collectors — first copies confirmed in 2000; first online auction in September 2003',
  },
  {
    id: 'marble-madness-ii-marble-man',
    title: 'Marble Man: Marble Madness II',
    developer: 'Atari Games',
    platform: 'Arcade',
    year: 1991,
    status: 'Cancelled after location testing — prototype dumped in 2022',
    description: 'Atari\'s sequel to Marble Madness added flight, invisibility, and pinball minigames — then died on location test in 1991, unable to compete with the Street Fighter II machine next to it.',
    longDescription: 'Marble Man: Marble Madness II was planned as the 1991 arcade sequel to Atari\'s beloved 1984 isometric marble-rolling game. Notably, Mark Cerny — the creator of the original, and later the architect of the PlayStation 4 and 5 — was not involved. Development was instead led by Bob Flanagan, who designed the sequel around what he believed had made Marble Madness successful in the home console market rather than the arcade.\n\nThat reasoning shaped an ambitious and rather strange game. Flanagan wanted to address the original\'s notorious brevity, and with Mike Hally he developed seventeen courses — a substantial expansion. The marble gained new abilities including invisibility and flight, pinball minigames were inserted between sets of levels, and up to three players could compete across the isometric courses simultaneously. Reasoning that the arcade\'s demographic had grown younger, Flanagan introduced the character Marble Man to make the sequel more approachable.\n\nThe location tests killed it. Atari built prototypes and put them into arcades to gauge player response, and the game simply could not compete with what was standing beside it — 1991 was the year of Street Fighter II, and a whimsical isometric marble game did not stand a chance against the machine that was reshaping the entire industry. Atari revised the design and tested again, met the same indifferent reception, and halted production, redirecting the team toward the beat-\'em-up Guardians of the \'Hood.\n\nThe prototypes survived, and for three decades Marble Man existed only as rumour and a handful of location-test cabinets. Then, in 2022, a prototype of the joystick-controlled version leaked online, and on 21 May 2022 a user known as Dank2079 mysteriously dumped the ROM and uploaded it to the Internet Archive. A game that had been seen by a few hundred arcade-goers in 1991 became, thirty-one years later, playable by anyone — a small victory for preservation over commercial oblivion.',
    keyFacts: [
      'Mark Cerny, creator of the original Marble Madness, was not involved in the sequel',
      'Led by Bob Flanagan, who with Mike Hally built seventeen courses and added flight and invisibility',
      'Featured pinball minigames between level sets and up to three simultaneous players',
      'Failed location testing in 1991, unable to compete against Street Fighter II',
    ],
    discoveredBy: 'Prototype leaked and dumped to the Internet Archive on 21 May 2022 by a user known as Dank2079',
  },
  {
    id: 'super-marios-wacky-worlds',
    title: 'Super Mario\'s Wacky Worlds',
    developer: 'NovaLogic',
    platform: 'Philips CD-i',
    year: 1993,
    status: 'Cancelled at pre-alpha — prototypes leaked',
    description: 'A genuine Super Mario World sequel, built for the Philips CD-i by an American studio, which Nintendo actually approved of — before the CD-i\'s collapsing sales killed it at roughly 80% complete art and 30% code.',
    longDescription: 'Super Mario\'s Wacky Worlds is the great what-if of the CD-i era. Developed by NovaLogic — later famous for the Delta Force military shooters — it was conceived as a genuine sequel to Super Mario World, the 1990 Super NES masterpiece, and built for Philips\'s ill-fated CD-i platform under the licensing arrangement that also produced the notorious Zelda CD-i games.\n\nUnlike those titles, which are remembered as embarrassments, Wacky Worlds was taken seriously and reportedly received positive feedback from Nintendo when an early prototype was shown. The game was a side-scrolling Mario platformer built along Super Mario World\'s lines, with worlds themed around real locations on Earth, and the surviving builds suggest a competent, faithful entry rather than the shovelware the CD-i is now synonymous with.\n\nDevelopment began in 1992 and ran until June 1993, and the game got substantially further than most cancelled projects. The final prototype is a pre-alpha, version 0.11, completed on 3 March 1993 after roughly a year of work, and the project had reached approximately 80 percent of its art, 95 percent of its design, and around 30 percent of its code. The unfinished code is what damns it: a game with nearly all its assets and almost none of its engine.\n\nWhat killed it was not quality but the platform. The CD-i\'s sales were collapsing, and there was no commercial logic in finishing a Mario game for a machine nobody was buying. Development was halted, and three prototypes have since entered circulation among collectors; one sold on eBay for $1,000, and a build has been leaked in ISO form and can be played on emulators or burned to a disc for real CD-i hardware. It stands as a poignant curiosity: the last officially sanctioned Mario platformer Nintendo never made, stranded on the worst console ever to carry its characters.',
    keyFacts: [
