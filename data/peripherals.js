...
module.exports = [
  ...
  },
  {
    ...
    platform: 'Nintendo Entertainment System',
    era: '8-bit',
    description: 'The NES Advantage was Nintendo\'s first-party arcade stick for the NES, bringing an 8-way joystick, large face buttons, and a turbo fire switch to home players who wanted an experience closer to their favourite coin-operated machines.',
    longDescription: 'The NES Advantage arrived in 1987 at a time when the NES\'s game library had grown substantially toward arcade conversions — Contra, Commando, Ikari Warriors, Trojan — that were far more comfortable to play with a joystick than a d-pad. Nintendo\'s design was substantial and well-constructed: a large octagonal-gated joystick, two oversized red action buttons, and a horizontal layout reminiscent of a tabletop arcade control panel. The peripheral weighed significantly more than a standard NES controller and was designed to be placed on a flat surface during play rather than held in the hands.\n\nThe Advantage\'s two most significant features were its turbo switches and its slow-motion function. Dedicated A and B turbo toggles allowed rapid fire to be engaged for each button independently, a capability that was critically useful in bullet-heavy shooters like Life Force and Gradius. The slow-motion feature — achieved by rapidly toggling the console\'s pause signal — worked across all NES games without requiring any software support, making it a genuinely universal accessibility tool at a time when difficulty was rarely adjustable. These features made the Advantage popular among players who wanted a competitive edge in arcade-style games.\n\nThe Advantage was a premium product at approximately $49.99 — more than the standard NES controller — but sold well throughout the NES\'s commercial life. Its build quality was markedly superior to many third-party arcade sticks of the period, which used cheaper switches and looser joystick gates that degraded rapidly with use. The Advantage\'s joystick used reliable microswitches that retained their action across years of play. Nintendo followed it with the NES Max (1988), a more compact turbo controller, and the Super NES had its own equivalent in the SNES Advantage, though neither achieved the original\'s cultural footprint.\n\nFor a generation of players who had spent time at arcades and wanted that physical experience translated to their living rooms, the Advantage was the defining NES accessory. Its distinctive silhouette — two big red buttons flanking a black joystick on a grey base — is immediately recognisable to anyone who grew up with the NES, and working examples are still sought by collectors who prefer joystick control for the platform\'s extensive arcade conversion library.',
    keyFacts: [
      'Featured independent turbo switches for both A and B buttons, useful in scrolling shooters',
      'Slow-motion function worked on all NES games by rapidly toggling the pause signal',
      'Retailed at approximately $49.99, nearly the cost of an NES game',
      'Used reliable microswitches for the joystick, giving it superior longevity to most third-party alternatives',
    ],
    verdict: 'The NES Advantage succeeded as a premium first-party accessory, offering genuine build quality and useful features that justified its price for players with serious interest in the NES arcade library.',
  },
  {
    id: 'super-scope',
    name: 'Super Scope',
  ...
  },
  {
    ...
    era: '16-bit / 32-bit transition',
    description: 'The Sega 32X was an add-on unit that connected to the Genesis cartridge port and added two 32-bit SH-2 processors and enhanced graphics capability, intended as a stopgap 32-bit upgrade while the Saturn was developed — and remembered as one of gaming\'s greatest strategic miscalculations.',
    longDescription: 'The 32X was conceived in 1994 as Sega of America\'s response to pressure from third parties and retailers who wanted a 32-bit Sega product to compete with the incoming Sony PlayStation and the 3DO. Sega of Japan was developing the Saturn as its true next-generation platform, but Saturn\'s Japanese launch was planned for late 1994 and its North American launch for 1995, leaving a gap that Sega of America feared competitors would exploit. The 32X was developed in just six months — an extraordinarily compressed schedule for console hardware — and launched in North America in November 1994 at $159.99, just weeks after the PlayStation launched in Japan.\n\nThe hardware itself was more capable than its troubled history suggests. Two Hitachi SH-2 processors running at 23 MHz provided genuine 32-bit computing power, supplemented by a custom video display processor that could produce 32,768 colours simultaneously — far more than the Genesis\'s 512-colour palette. The 32X also added a PWM audio channel. Games like Virtua Racing Deluxe demonstrated that the hardware could produce polygon-based 3D games competitive with early PlayStation software. The problem was not the hardware\'s capability but the context of its release: the Saturn launched in Japan in November 1994, the same month as the 32X, and both products competed for Sega\'s own development resources and consumer attention.\n\nThe 32X library totalled 40 games across its 14-month commercial lifespan, including ports of Virtua Fighter, Doom, Star Wars Arcade, and several original titles. The add-on also enabled the use of the Sega CD simultaneously when combined in the "32X CD" configuration, though only six games used this combination. Third-party support was thin — developers were reluctant to commit resources to a platform of uncertain lifespan, particularly once it became clear that the Saturn was Sega\'s actual future. Sega discontinued the 32X in 1996 after selling approximately 800,000 units globally, a small fraction of the 29 million Genesis units installed. Retailers were left with unsold inventory and customers felt abandoned.\n\nThe 32X became the symbol of Sega\'s strategic dysfunction in the mid-1990s — a period when the company simultaneously maintained the Genesis, Sega CD, 32X, and Saturn in the market, fragmenting consumer attention and developer resources. Sega\'s American CEO Tom Kalinske publicly expressed reservations about the 32X\'s launch timing that were overruled by Sega Japan, and the episode is frequently cited in post-mortems of Sega\'s decline. The hardware\'s failure contributed to the erosion of retailer and consumer confidence that undermined the Saturn\'s subsequent launch.',
    keyFacts: [
      'Developed in approximately six months — an unusually compressed hardware development schedule',
      'Two Hitachi SH-2 processors at 23 MHz gave it genuine 32-bit capability competitive with early PlayStation games',
      'Only 40 games were released for the platform across its 14-month commercial lifespan',
      'Sold approximately 800,000 units globally against a Genesis installed base of 29 million',
    ],
    verdict: 'The 32X failed catastrophically, abandoned by Sega within 14 months, and became the definitive symbol of the company\'s mid-1990s strategic incoherence — simultaneously launching with the Saturn it was meant to complement rather than compete against.',
  },
  {
    id: 'sega-activator',
    name: 'Sega Activator',
  ...
  {
    id: 'atari-driving-controller',
    name: 'Atari Driving Controller',
    manufacturer: 'Atari',
    year: 1977,
    platform: 'Atari 2600',
    era: 'Pre-NES',
    description: 'The Atari Driving Controller was a dedicated paddle-style dial controller bundled with Indy 500 for the Atari 2600, using a rotary encoder to provide 360-degree analogue steering input decades before analogue sticks became standard.',
    longDescription: 'The Atari Driving Controller was designed specifically for the launch title Indy 500 (1977), one of the nine games available at the Atari 2600\'s release. Where Atari\'s standard joystick used four digital directional inputs, the Driving Controller used a continuously rotating dial — a rotary encoder — that tracked angular velocity rather than position. This meant the faster a player turned the wheel, the faster their in-game car turned, with no centre position or return-to-neutral behaviour. The encoding wheel could spin indefinitely in either direction, accurately replicating the feel of a steering wheel input in a way that digital joystick alternatives could not.\n\nThe controller\'s physical design was intentionally automobile-themed: a squat cylindrical base with a flared, bowl-shaped top that could be gripped and spun. A single red button on the top surface provided the brake or action input depending on the game. The pairing with Indy 500 was effective — the game\'s overhead racing gameplay benefited substantially from analogue steering input, and the combination was considered one of the stronger launch package experiences on the 2600. Atari sold the controllers in pairs, as Indy 500 supported two-player simultaneous racing and the experience was most compelling with two drivers.\n\nCompatibility with other 2600 games was limited but non-zero. Several sports titles and a handful of other games used the controller\'s dial for analogue input, and the controller used the same 9-pin DE-9 connector as all Atari 2600 peripherals, meaning it could be plugged in to any game even if the game had not been specifically designed for it — sometimes producing interesting accidental input behaviours. The Atari 5200 later used a true analogue joystick with a spring-centred stick, but the Driving Controller\'s continuous-rotation encoding remained the superior solution for steering inputs specifically.\n\nThe Atari Driving Controller is significant in gaming history as one of the earliest demonstrations that different game genres required fundamentally different input devices — a principle that the industry would take decades to fully act on. The controller predated Nintendo\'s analogue stick by nearly twenty years and Logitech\'s first analogue steering wheel peripherals by over a decade, making it a surprisingly forward-thinking piece of hardware for 1977.',
    keyFacts: [
  ...
  {
    id: 'steel-battalion-controller',
    name: 'Steel Battalion Controller',
    manufacturer: 'Capcom',
    year: 2002,
    platform: 'Xbox',
    era: '2000s',
    description: 'Forty-four inputs across three pieces of hardware, including foot pedals and a physical eject lever you had to hit before your mech exploded. It cost $200 and came with a game attached.',
    longDescription: 'Steel Battalion was created by Capcom in 2002, developed by Nude Maker — largely former Human Entertainment staff — with Capcom Production Studio 4, and it cannot be played with a normal controller. It ships with its own, and the controller is the product.\n\nIt comprises 44 input points spread across a three-piece rig: two joysticks, a throttle handle, a radio channel dial, five switches, three foot pedals, an array of buttons, and — most famously — a dedicated eject button under a hinged safety cover. The player pilots a "Vertical Tank", a bipedal armed mecha, and the controller\'s layout mirrors the fiction: you do not press "start engine", you run an ignition sequence. The whole package, game included, retailed for $199.95.\n\nThe eject button is what made it legendary. If your VT is about to be destroyed, you must flip the cover and hit eject before it goes. Fail to do so and the game deletes your save. Not the mission — the save. The pilot died, and the game treats that as final, which is the single most committed piece of hardware-fiction integration in the medium. Only limited quantities were manufactured, they sold out, and the rig is now a serious collector\'s item.',
    keyFacts: [
      'The controller has 44 input points including two joysticks, a throttle, five switches and three foot pedals',
      'The game and its three-piece controller retailed together at $199.95',
      'A hinged safety cover protects the eject button, which must be hit before the mech is destroyed',
      'Failing to eject in time deletes the player\'s save file permanently',
      'Only limited quantities were produced; they sold out and are now highly collectible',
    ],
    verdict: 'The most extravagant peripheral ever bundled with a game, and the only one that punishes failure by erasing your progress — a commercially absurd object that remains the high-water mark of simulation-as-hardware.',
  },
  {
    ...
    platform: 'Famicom',
    era: '1980s',
    description: 'Nintendo put rewritable disks in the Famicom and installed kiosks across Japan where you could have a new game written onto your old one for ¥500 — digital distribution, in 1986, staffed by a human being.',
    longDescription: 'The Famicom Disk System launched in Japan on 21 February 1986. It replaced cartridges with proprietary floppy media called Disk Cards, which were substantially cheaper to manufacture, offered writable storage for saves, and added an extra high-fidelity sound channel that compatible games could use — the reason a handful of Famicom soundtracks sound noticeably richer than anything else on the hardware.\n\nThe genuinely radical part was the distribution model. Nintendo installed "Disk Writer" kiosks in toy and hobby shops across Japan, and announced in 1986 an intention to place 10,000 of them within a year. A customer could bring in a Disk Card they already owned, choose a game from a rotating roster, and have it written onto the disk for ¥500 — about $3.25 at the time, roughly a sixth of the price of a new game — and keep it indefinitely. Contrary to a persistent belief, these were not self-service vending machines; they sat behind the shop counter and were operated by trained staff.\n\nIt is, in every meaningful respect, digital distribution: a catalogue, a low unit price, no physical product manufactured per sale, and a customer who supplies their own storage. Nintendo built it in 1986 and then walked away from it as cartridge costs fell and capacities grew.',
    keyFacts: [
  ...
  },
  {
    ...
    platform: 'Nintendo 64',
    era: '1990s',
    description: 'A writable magnetic disk drive that bolted to the underside of the N64 — announced in 1995, delayed for four years, sold in Japan only to subscribers of an internet service, and discontinued inside fourteen months.',
    longDescription: 'The 64DD ("Disk Drive") was Nintendo\'s answer to the central limitation of the cartridge: cartridges are read-only and expensive per megabyte, while the CD-ROM its competitors had adopted was cheap but slow and equally unwritable. Nintendo\'s solution was a proprietary magnetic disk holding roughly 64 megabytes that the console could write back to. That read-write capability was the entire point. A 64DD game could store far more than a cartridge\'s battery-backed save, which opened the door to creation tools, persistent worlds, and content that grew as the player used it.\n\nThe hardware was announced in 1995 and shown at successive Nintendo Space World events, then slipped year after year while the N64\'s own commercial window closed around it. When it finally arrived in Japan on 1 December 1999, Nintendo did not put it on shelves as an ordinary accessory. It was distributed through Randnet, a subscription online service run as a joint venture with the recruitment company Recruit: subscribers received the drive and a modem and paid a monthly fee for network access, a browser, email, and disk-based software. Estimates of the subscriber base run to roughly fifteen thousand — a rounding error against an installed base of tens of millions of N64s.\n\nNine disks were released. Most of them are strange and interesting rather than substantial: the Mario Artist suite of painting, modelling and animation tools, SimCity 64, Doshin the Giant and its expansion, an F-Zero X Expansion Kit that let players build their own tracks and save them to disk. The service was shut down in February 2001 and the hardware discontinued with it. Several major titles conceived for the drive migrated elsewhere — most famously the expanded Zelda content long promised as "Ura Zelda", which eventually reached players as the GameCube-era Master Quest. The 64DD is the clearest surviving evidence of a version of the Nintendo 64 that was designed around user-created, persistent, networked content, several years before the industry had any of those things.',
    keyFacts: [
      'Announced in 1995 and repeatedly delayed; released in Japan on 1 December 1999',
      'Attached beneath the console via the N64\'s expansion port and used proprietary read-write magnetic disks of roughly 64 MB',
      'Sold only to subscribers of Randnet, a Nintendo–Recruit online service, and estimated to have reached only around 15,000 users',
      'Nine disks were released, including the Mario Artist creation tools, SimCity 64 and the F-Zero X Expansion Kit',
      'Discontinued in February 2001; the promised expanded Zelda content eventually surfaced as Master Quest',
    ],
    verdict: 'The most interesting failure in Nintendo\'s hardware history — a writable-media add-on built for user-created and networked content that arrived four years late, behind a subscription wall, on a console that had already moved on, and so proved almost nothing about whether the idea was any good.',
  },
  {
    id: 'super-game-boy',
    name: 'Super Game Boy',
    ...
    era: '1990s',
    description: 'A SNES cartridge with a Game Boy inside it — not an emulator but the actual handheld hardware, playing monochrome carts on a television with colour palettes and decorative borders.',
    longDescription: 'The Super Game Boy is a SNES cartridge containing genuine Game Boy hardware. The SNES does not emulate anything; it supplies power and a clock, receives video and audio from the Game Boy silicon inside the cartridge, and paints the result on a television. This architectural honesty is why compatibility was essentially perfect — a game running on a Super Game Boy is running on a Game Boy, on a slightly faster clock.\n\nThat clock is the accessory\'s best-known quirk. Because timing is derived from the SNES rather than from the handheld\'s own crystal, everything runs roughly 2.4% fast: music plays a shade sharp and games are marginally quicker than on hardware. The adapter added a four-colour palette selector, applied to a monochrome game\'s four shades, and a decorative border to fill the area of the screen the Game Boy\'s 160×144 image could not. Developers who cared could do considerably better than the defaults. A cartridge could carry Super Game Boy enhancement data specifying its own palettes, its own custom border artwork, and in some cases additional audio played through the SNES rather than the Game Boy\'s sound hardware — which is why Donkey Kong (1994), Kirby\'s Dream Land 2 and the Pokémon games look and sound conspicuously better through the adapter than the palette menu alone would allow.\n\nThe conspicuous omission was the link cable. The original Super Game Boy has no link port, so the trading and battling that defined the platform\'s biggest games were impossible through it. Nintendo addressed this with the Super Game Boy 2, released in Japan in 1998, which added a link connector and corrected the clock to the handheld\'s true speed. It never left Japan, which means that for the entire Western life of the accessory the definitive Game Boy social features were the one thing the television version could not do.',
    keyFacts: [
      'Contains real Game Boy hardware rather than emulating it; the SNES provides power, clock, video output and audio mixing',
      'Derives its clock from the SNES and therefore runs approximately 2.4% faster than a handheld Game Boy',
      'Enhanced cartridges could specify custom palettes, custom border artwork and extra SNES-side audio',
      'Has no link port, making Game Boy link-cable trading and battling impossible',
      'The Japan-only Super Game Boy 2 (1998) added a link connector and fixed the clock speed',
    ],
    verdict: 'An unusually elegant piece of engineering — Nintendo solved television compatibility by simply putting the handheld in the cartridge — undermined for Western players by the missing link port, a defect fixed only in a revision Japan kept to itself.',
  },
  {
    id: 'gba-e-reader',
    ...
    era: '2000s',
    description: 'A card scanner for the Game Boy Advance that read data printed as dot patterns along the edge of trading cards — a delivery mechanism for NES games, minigames and extra levels in an era before console downloads.',
    longDescription: 'The e-Reader is a Game Boy Advance accessory that reads "Dot Code" — data encoded as a dense field of microscopic dots printed in strips along the edge of a card, developed with Olympus. The player swipes the card through a slot on the side of the unit and the scanned data becomes software: a minigame, a set of item data, a level, or in the more ambitious cases an entire NES game. Nintendo released it in Japan on 1 December 2001 and in North America in September 2002. Europe never got it at all.\n\nThe format\'s appeal was that it made software a physical, collectible, cheap-to-print object at a moment when consoles had no practical way to distribute small pieces of content. Card sets included NES titles such as Excitebike, Donkey Kong Jr., Balloon Fight and Ice Climber, each requiring a set of cards swiped in sequence; Pokémon-e trading cards that were playable TCG cards and software both; and, most substantially, the world-e levels for Super Mario Advance 4: Super Mario Bros. 3, which added dozens of new Mario levels to a 1988 game via cardboard. Animal Crossing on the GameCube used e-Reader cards to hand players NES games and town items, tying two consoles together through a stack of trading cards.\n\nThe hardware had an awkward regional history. The original Japanese unit lacked the external connector needed to link to a second system, which the later Japanese revision and the North American release both included — a distinction that determines which cards a given unit can usefully do anything with. The accessory faded quickly in the West as retailers lost interest in stocking card packs, and much of the world-e content released in Japan never reached North America. It remains one of the more inventive answers anyone gave to the question of how to deliver small downloadable content to a console generation that could not download.',
    keyFacts: [
      'Read "Dot Code" data printed along card edges, a technology developed with Olympus',
      'Released in Japan on 1 December 2001 and in North America in September 2002; never released in Europe',
      'Card sets delivered NES games, Pokémon-e TCG cards, and the world-e level packs for Super Mario Advance 4',
      'The original Japanese unit lacked the link connector included on the later Japanese revision and the North American release',
      'Animal Crossing on GameCube used e-Reader cards to unlock NES games and in-game items',
    ],
    verdict: 'A genuinely clever solution to a problem that solved itself — printing downloadable content on trading cards worked, and produced some of the best late Mario levels ever made, but the moment consoles could actually download things the whole apparatus became a curiosity.',
  },
];
