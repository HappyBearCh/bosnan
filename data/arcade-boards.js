...
module.exports = [
  ...
  },
  {
    ...
    keyFacts: [
      'Bitmap display with no sprite hardware — every object drawn into a 304×256, 16-colour frame buffer',
      'Defender and Stargate moved all graphics with the 1 MHz 6809E alone; no blitter',
      'Robotron and later games added two 4-bit "Special Chip" blitters for DMA graphics moves',
      'Established the fast, high-object-count Williams house style under designer Eugene Jarvis',
    ],
    keyword: 'Williams 6809',
  },
  {
    id: 'atari-system-1',
    sources: [
