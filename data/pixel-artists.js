...
module.exports = [
  ...
  },
  {
    ...
    nationality: 'British',
    era: '1990s',
    description: 'The artist who gave The Bitmap Brothers their metallic, riveted, unmistakably industrial look — the visual identity that made a small British studio feel like a brand.',
    longDescription: 'The Bitmap Brothers occupy an unusual place in British games history: a development studio that was marketed like a band, with a logo, a house style and a reputation that preceded any individual game. A large part of what made that possible was Dan Malone\'s artwork. His graphics gave the studio a consistent visual register — heavy metal plating, rivets, deep shadow, chrome and rust — that was recognisable across titles that shared no genre or setting.\n\nHis best-known work is on Speedball 2: Brutal Deluxe, Gods, Magic Pockets and The Chaos Engine. Speedball 2\'s armoured players and grimy stadium furniture established the template; Gods applied the same weight and shadow to a mythological setting, giving a platform game the visual density of something far more expensive. The Chaos Engine went furthest, building a Victorian steampunk world of brass, foliage and clanking machinery that was unusually coherent for an early-1990s Amiga title — the aesthetic is largely his, and it is the reason the game still looks designed rather than merely drawn.\n\nWhat distinguishes his pixel work technically is restraint with the palette. The Amiga\'s standard modes gave an artist very few colours, and the common failure was to spend them on hue variety. Malone spent them on light: narrow ranges of grey, brown and steel-blue used to model form, with saturation reserved for the few elements meant to draw the eye. The result reads as lit rather than coloured, which is why the work survived the transition to higher-resolution displays with its authority intact while a great deal of contemporary art did not.',
    notableWork: [
      'Speedball 2: Brutal Deluxe — armoured players and the grimy industrial stadium look',
      'Gods — mythological platforming rendered with unusual weight and shadow',
      'The Chaos Engine — the Victorian steampunk world of brass and machinery',
      'Magic Pockets — a brighter register within the same house style',
      'The Bitmap Brothers\' overall visual identity across their catalogue',
    ],
    keyFacts: [
      'Defined the metallic, riveted house style associated with The Bitmap Brothers',
      'Worked on Speedball 2: Brutal Deluxe, Gods, Magic Pockets and The Chaos Engine',
      'The Chaos Engine\'s steampunk aesthetic is largely attributable to his design work',
      'Used the Amiga\'s limited palette for lighting and form rather than hue variety',
      'Helped make a development studio itself into a recognisable consumer brand',
    ],
    keyword: 'Bitmap Brothers art',
  },
  {
    id: 'henk-nieborg',
    name: 'Henk Nieborg',
    nationality: 'Dutch',
    era: '1990s',
    description: 'The Dutch artist whose densely detailed Amiga backgrounds set the ceiling for 16-bit scenery — and who is still producing pixel art professionally three decades later.',
    longDescription: 'Henk Nieborg emerged from the European Amiga scene of the early 1990s, and his signature is detail density: backgrounds packed with foliage, masonry, rot and texture, dithered with a patience that most commercial schedules did not allow. His breakthrough was Lionheart for Thalion, a game whose reputation rests substantially on how it looks. Its layered parallax scenery, elaborate creature design and lush colour work were held up at the time as evidence of what the Amiga could do when an artist pushed the hardware rather than working comfortably within it.\n\nHe followed it with The Adventures of Lomax for Psygnosis, a platform game whose art carried the same handmade density onto newer hardware. Where many artists of his generation left pixel work behind as 3D took over, Nieborg treated the medium as a discipline rather than a limitation, and kept working in it — later contributing to WayForward projects including Contra 4 on the Nintendo DS and entries in the Shantae series, whose look owes a great deal to the European tradition he came out of.\n\nHis technical reputation rests on dithering. Where the palette runs out, Nieborg mixes two available colours in patterned arrangements that the eye resolves into a third, producing gradients and surface textures that the hardware cannot literally display. Done badly this reads as noise; done at his level it reads as stone, moss and bark. That craft is why his work is a standing reference for pixel artists, and why his career bridges the Amiga era and the modern independent scene without a break in the middle.',
    notableWork: [
      'Lionheart (Thalion, Amiga) — the layered, densely detailed scenery he is best known for',
      'The Adventures of Lomax (Psygnosis) — the same handmade density on newer hardware',
      'Contra 4 (Nintendo DS, WayForward)',
      'Entries in the Shantae series',
      'A continuing body of professional pixel art spanning three decades',
    ],
    keyFacts: [
      'Came out of the European Amiga scene and made his name with Lionheart for Thalion',
      'Known for extremely dense background detail and expert dithering',
      'Continued working in pixel art after most of his generation moved to 3D',
      'Later contributed to WayForward titles including Contra 4 and the Shantae series',
      'His technique remains a standing reference for working pixel artists',
    ],
    keyword: 'Amiga pixel art',
  },
  {
    id: 'ayano-koshiro',
    name: 'Ayano Koshiro',
    nationality: 'Japanese',
    era: '1990s',
    description: 'Character designer and graphic artist at Ancient, the family studio she founded with her brother Yuzo — the visual half of one of the most distinctive creative partnerships of the Mega Drive era.',
    longDescription: 'Ancient Corp was founded in 1990 as a family concern: the composer Yuzo Koshiro, his sister Ayano, and their mother Tomo, who ran the company. The arrangement is unusual in Japanese games history and it produced an unusually tight loop between music and image, since the studio\'s two defining creative voices shared a surname and a workspace. Ayano Koshiro\'s side of that partnership is the art — character design and graphic work across a run of Sega-era titles whose look is as recognisable as their soundtracks.\n\nHer credits include character design on The Revenge of Shinobi, whose armoured, poster-ready ninja iconography did a great deal to establish the Mega Drive\'s early visual tone, and graphic work on the 8-bit Sonic the Hedgehog that Ancient developed for the Master System and Game Gear — a version that had to reinvent the character\'s look for hardware with a fraction of the colour and resolution of the original. Later came Beyond Oasis (released in Japan as The Story of Thor), an action RPG whose character and world design carried a warmth and clarity of silhouette that set it apart from its contemporaries.\n\nThe constraint she worked under is worth stating plainly. A Mega Drive character sprite is a few dozen pixels tall with a handful of colours drawn from a restricted palette, and it has to read instantly at speed, in motion, on a CRT, from across a room. Every design decision is therefore a decision about silhouette and contrast rather than detail. Her work is consistently legible under those conditions, which is why the characters survive being scaled up, redrawn and reused decades later — the identity is in the shape, and the shape was designed to work at the size the hardware allowed.',
    notableWork: [
      'The Revenge of Shinobi — character design for one of the Mega Drive\'s defining early titles',
      'Sonic the Hedgehog (8-bit, Master System and Game Gear) — graphic work for Ancient\'s version',
      'Beyond Oasis / The Story of Thor — character and world design',
      'Co-founder of Ancient Corp alongside her brother Yuzo and their mother Tomo',
      'A continuing body of art across Ancient\'s later output',
    ],
    keyFacts: [
      'Co-founded Ancient Corp in 1990 as a family studio with composer Yuzo Koshiro and their mother Tomo',
      'Provided character design for The Revenge of Shinobi on the Mega Drive',
      'Worked on the 8-bit Sonic the Hedgehog developed by Ancient for Master System and Game Gear',
      'Designed the characters and world of Beyond Oasis, known in Japan as The Story of Thor',
      'Her designs prioritise silhouette and contrast, which is why they survive being redrawn at any size',
    ],
    keyword: 'Ancient Corp character design',
  },
];
