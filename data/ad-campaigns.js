...
module.exports = [
  ...
  },
  {
    ...
    year: 1997,
    era: '1990s',
    product: 'Sega Saturn (Japan)',
    tagline: 'Sega Saturn, shiro! ("Play Sega Saturn!")',
    description: 'To sell the struggling Saturn in Japan, Sega invented a stern judo master who physically assaulted anyone caught not playing it — a campaign so beloved it outlived the console and became a folk hero.',
    longDescription: 'By the summer of 1997 the Sega Saturn was in trouble in Japan — moderately successful, but losing ground to the PlayStation and more than two years past its launch. Sega\'s response was not a specs comparison or a price cut but a character: Segata Sanshiro, a grim, headband-wearing martial artist in a judo gi whose entire purpose was to command people to play the Sega Saturn. His name was a pun on Sugata Sanshiro, the judo hero of Akira Kurosawa\'s 1943 debut film, and his catchphrase — "Sega Saturn, shiro!" ("Play Sega Saturn!") — punned on the console\'s name.\n\nThe premise of the ads was absurd and violent in a way that was purely comic. Segata would discover someone doing something other than playing the Saturn — going on a date, practising baseball, ignoring a friend — and hurl them across the room with a judo throw before ordering them to play. He was portrayed by Hiroshi Fujioka, the actor famous for playing the original Kamen Rider and a genuinely trained martial artist across karate, iaido, and judo, which let the throws land with real physical conviction. The first television spot aired on 28 November 1997, promoting Sonic R.\n\nThe campaign ran through 1998, and its cultural footprint outgrew the hardware it was meant to sell. Segata\'s theme song was released as a CD single; he was given his own Saturn game, Segata Sanshiro Shinken Yugi; and he was widely credited with helping Saturn sales in Japan during his run. The character\'s send-off, in which he sacrifices himself to save Sega\'s headquarters from a missile, gave the mascot a mythic finality that fans have treasured ever since.\n\nSegata Sanshiro is remembered as one of the great video-game advertising creations precisely because the campaign committed fully to a bit that had nothing to do with the product\'s features. It sold the Saturn on personality and repetition — a memorable face, an order you could not forget, and a joke that got funnier the more he threw people — at a moment when the hardware had lost the specifications argument. He remains a cult figure in Japan long after the console he championed was discontinued.',
  ...
  {
    id: 'playstation-299',
    title: 'The Price of $299',
    company: 'Sony Computer Entertainment America',
    year: 1995,
    era: '1990s',
    product: 'Sony PlayStation',
    tagline: '$299',
    description: 'Sony\'s entire E3 1995 message was a single number. After Sega announced the Saturn at $399, SCEA\'s Steve Race walked to the podium, said "two-ninety-nine," and walked off — one of the most effective moments in games marketing.',
    longDescription: 'The launch of the PlayStation in North America turned on a single number delivered at the first Electronic Entertainment Expo in May 1995. The context made the moment. Earlier that day, Sega had used its own presentation to announce that the Sega Saturn was available immediately at a US retail price of $399 — a surprise "launch today" gambit meant to steal a march on Sony. Sony had the last word of the day, and it chose to make that word arithmetic.\n\nAfter a presentation covering the PlayStation\'s games, Steve Race — the SCEA executive leading the console\'s US launch — came to the podium, said "two-ninety-nine," and left the stage without another word. The PlayStation would cost $299, a full $100 less than the Saturn Sega had just priced. The audience of retailers and press erupted. The economy of the moment was its whole power: no slide of features, no comparison chart, just the price undercutting a competitor who had committed to a higher number hours earlier and could not easily walk it back.\n\nThe number did the work the rest of the launch needed. It framed the PlayStation as the better deal at the exact instant the industry was deciding which fifth-generation console to get behind, and it caught Sega flat-footed — the Saturn\'s surprise early launch, intended as an advantage, had instead locked Sega into a price it now looked bad next to, with limited stock and retailers already stung by being cut out of the surprise rollout. E3 1995 is remembered as the moment the fifth-generation console war tilted toward Sony, and "$299" is remembered as one of the first true mic-drops in the industry\'s history.\n\nThe episode is a case study in message discipline. Sony had every incentive to talk about the PlayStation\'s hardware, its developer relationships, or its games, and it had material to do so. Instead it reduced the entire competitive argument to one number a tired trade-show audience could not fail to remember, and let the contrast with Sega\'s $399 carry the rest. The single-word speech is taught as an example of saying less to say more.',
    impact: 'The $299 announcement undercut the Saturn by $100 at the decisive moment, is widely credited with turning the 32-bit console war toward Sony, and became an enduring example of message discipline in marketing.',
    keyFacts: [
      'Delivered at E3 1995 hours after Sega priced the Saturn at $399 with a surprise same-day launch',
      'SCEA\'s Steve Race said only "two-ninety-nine" and walked off stage',
      'Undercut the Saturn by $100 at the moment retailers were choosing sides',
      'Remembered as one of the first "mic-drop" moments in the games industry',
    ],
  },
  {
    id: 'nintendo-play-it-loud',
    title: 'Play It Loud!',
    company: 'Nintendo of America',
    year: 1994,
    era: '1990s',
    product: 'Nintendo (SNES / Game Boy)',
    tagline: 'Play It Loud!',
    description: 'Stung by Sega\'s cool, Nintendo spent $10 million reinventing itself for teenage boys — skate parks, graffiti, hard rock, and coloured Game Boys — trading the family-friendly image for attitude.',
    longDescription: 'By 1994 Nintendo had a perception problem that Sega had spent years creating: Nintendo was for kids, Sega was for teenagers. The "Play It Loud!" campaign, which ran from July 1994 through September 1996 on roughly a $10 million budget produced by the Leo Burnett agency, was Nintendo of America\'s attempt to take that attitude back. It aimed squarely at the company\'s core demographic — teenage boys — and abandoned the wholesome imagery that had defined Nintendo\'s marketing since the NES.\n\nThe advertisements were built from counter-cultural signifiers. Commercials flashed slogans like "CRANK IT!", "THEY CAN\'T HEAR YOU!", and "FIGHT EARWAX!" over footage of youths at skate parks tagged with Nintendo-themed graffiti, and the copy leaned hard on the slang of the moment, advising viewers to "hock a loogie at life" and "give the world a wedgie." Music was central: the campaign married hard rock to video games, with one early spot featuring the alternative band the Butthole Surfers — a striking choice for a company whose previous public face had been Mario.\n\nThe campaign\'s most durable artefact was hardware. On 20 March 1995 Nintendo released Game Boy models in coloured cases — red, green, black, yellow, white, blue, and a transparent "clear" version that let owners see the electronics inside — marketed directly under the "Play It Loud!" banner. The coloured and transparent Game Boys turned a fixed piece of grey plastic into a fashion object and a statement of identity, and they became some of the most collectible Game Boy variants precisely because they carried the campaign\'s ethos in physical form.\n\n"Play It Loud!" marked a permanent shift in how Nintendo presented itself. So much money and design work went into the project that its aesthetic ended up stamped on nearly every Super Nintendo and Game Boy product of the mid-1990s, from packaging to peripherals. It did not out-cool Sega overnight, but it retired the idea that Nintendo would cede attitude to its rival by default — and the transparent Game Boy remains one of the most recognisable pieces of 1990s gaming design.',
    impact: 'Repositioned Nintendo toward teenage boys for the mid-1990s, stamped its aesthetic across SNES and Game Boy packaging, and produced the coloured and transparent Game Boy models that became enduring collector items.',
    keyFacts: [
      'Ran July 1994 to September 1996 on a roughly $10 million budget, produced by Leo Burnett',
      'Aimed at teenage boys with skate parks, graffiti, and slogans like "CRANK IT!" and "THEY CAN\'T HEAR YOU!"',
      'One early spot featured alternative rock band the Butthole Surfers',
      'Launched coloured and transparent Game Boy cases on 20 March 1995 — now collector favourites',
    ],
  },
];
