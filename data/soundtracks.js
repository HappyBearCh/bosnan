...
module.exports = [
  ...
  {
    id: 'actraiser-ost',
    title: 'ActRaiser Original Soundtrack',
    game: 'ActRaiser',
    platform: 'SNES',
    year: 1990,
    ...
    era: '1990s',
    trackCount: 27,
    description: 'Yuzo Koshiro\'s ActRaiser score was the soundtrack that convinced the industry the SNES could do orchestral music, its sweeping, classically-minded themes leaving rival composers, in their own words, floored.',
  ...
  },
  {
    ...
    era: '1990s',
    trackCount: 34,
    description: 'Koji Kondo\'s Super Mario 64 score reinvented the sound of Mario for three dimensions, trading tight 2D loops for airy, jazz-inflected themes that matched the freedom of the series\' first open 3D worlds.',
    ...
    keyFacts: [
      'Composed entirely by Koji Kondo for the Nintendo 64\'s 1996 launch title',
      'Traded the tight 2D loops of earlier Mario music for open, jazz-inflected exploration themes',
      'Used the N64\'s sample-based audio for warmer, more acoustic instrument timbres',
      'The soundtrack album opens with Charles Martinet\'s "It\'s-a me, Mario!" voice clip',
      'Closes with a bonus piano version of "Piranha Plant\'s Lullaby" performed by Kondo',
    ],
    sections: [
      {
        title: 'Music for a World You Could Wander',
        html: '<p>Two-dimensional Mario games moved the player relentlessly rightward, and Kondo\'s music matched that drive with compact, high-energy loops. Super Mario 64 removed the forced momentum: its worlds were places to explore in any direction, revisit, and linger in. Kondo answered with a fundamentally different kind of writing — themes that breathe, built on jazz harmony and unhurried melodies that reward long play rather than pushing the player onward. "Dire, Dire Docks" is the clearest example, a track designed to be dwelt in rather than run through.</p><p>This shift mirrored the game design itself. Where the level was once a corridor, it was now a space, and the score had to fill space rather than propel motion. Kondo\'s solution defined the musical grammar of 3D Mario for years to come.</p>',
      },
      {
        title: 'Familiar in a New Voice',
        html: '<p>For all its novelty, the score stayed anchored to Mario\'s established identity through motif. Kondo laced fragments of the series\' recognisable melodies through new arrangements, so that a player hearing the Bob-omb Battlefield theme registered both a fresh tune and the reassurance of home. The Nintendo 64\'s sample-based sound hardware let those familiar shapes arrive in warmer, more rounded timbres than the square waves of the NES, softening the transition from chip-tune to something closer to a small acoustic ensemble.</p><p>That balance — genuinely new music that never stops sounding like Mario — is why the Super Mario 64 soundtrack is counted among Kondo\'s most celebrated works, and why its themes have been re-arranged across the franchise ever since.</p>',
      },
    ],
  },
  {
    id: 'silent-hill-2-ost',
    title: 'Silent Hill 2 Original Soundtrack',
    game: 'Silent Hill 2',
    ...
    era: '2000s',
    trackCount: 41,
    description: 'Akira Yamaoka\'s Silent Hill 2 score fused ambient dread, industrial noise, and aching trip-hop melody into one of the most emotionally complex soundtracks in horror gaming, anchored by the mournful "Theme of Laura."',
    ...
    sections: [
      {
        title: 'Score as Psychological State',
        html: '<p>Silent Hill 2 uses music the way other horror games use monsters: as a direct line into the protagonist\'s mind. Yamaoka refused the genre\'s reflex toward orchestral stingers, instead building a palette from ambient drone, trip-hop beats, muted rock, and industrial abrasion, and shifting between them to track James Sunderland\'s psychological unravelling. Beauty and ugliness are placed deliberately side by side — a fragile melody can dissolve into mechanical noise without warning, refusing the player any stable emotional footing.</p><p>"Theme of Laura" embodies the approach. Its warm, guitar-driven tenderness would be at home on a melancholy pop record, and dropping that tenderness into a game about grief, guilt, and horror is exactly what makes it devastating. Yamaoka understood that the most disturbing sound in a horror game can be a beautiful one heard in the wrong place.</p>',
      },
      {
        title: 'One Author for Every Sound',
        html: '<p>Yamaoka\'s control over Silent Hill 2\'s audio extended past the music to the game\'s roughly fifty core sound effects, which he designed himself — screams, the scrape of footsteps on broken glass, the industrial groans of the Otherworld. Because the same person authored both the score and the noise, the boundary between them is intentionally porous: a sustained tone can be music, ambience, or threat, and the player is rarely allowed to be sure which.</p><p>This unified authorship is why the soundtrack works so differently in and out of the game. On its own, the 2001 album stands as a striking piece of electronic and ambient music; in play, those same sounds become an instrument of dread. Few horror scores have collapsed the distinction between soundtrack and sound design so completely, and it remains the model later atmospheric horror games are measured against.</p>',
      },
    ],
  },
];
