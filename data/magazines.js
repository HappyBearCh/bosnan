...
module.exports = [
  ...
  },
  {
    ...
    keyword: 'Next Generation magazine',
  },
  {
    id: 'amiga-power',
    name: 'Amiga Power',
    ...
    closed: 1996,
    era: '1990s',
    description: 'The magazine that used the whole percentage scale, published a table comparing its scores to everyone else\'s to prove the others were inflating, and got its ad revenue pulled for it.',
    longDescription: 'Amiga Power launched in May 1991 from Future Publishing and ran for 65 issues until September 1996. Its founding principle was brutal honesty about review scores, and it pursued that principle with a consistency that repeatedly brought it into open conflict with the industry it covered.\n\nThe core of the argument was arithmetic. Amiga magazines of the period skewed the percentage scale so that a merely average game scored around 70%, compressing all meaningful judgement into the top third of the range. Amiga Power insisted on using the full scale — a 50% game was genuinely mediocre, and a bad game could and did score in the teens. Because publishers and readers alike had internalised the inflated convention, AP acquired an entirely undeserved reputation for harshness, when in fact it was the only publication being straight.\n\nIt then made the point unignorable. In later issues it ran a regular table called The Disseminator, which simply listed the scores rival magazines had awarded a game alongside AP\'s own, exposing the gap. The industry response was predictable: Team17 in particular withdrew its advertising and stopped supplying advance review copies. The magazine flourished anyway, and its reputation has only grown since — it is now routinely cited as the moment British games journalism decided that its obligation ran to its readers rather than to its advertisers.',
    notableIssues: [
  ...
  },
  {
    ...
    closed: 1996,
    era: '1990s',
    description: 'A British SNES magazine from Future Publishing, revered for its deep focus on Japanese games, anime, and import RPGs, and for Wil Overton\'s manga-style cover art — a publication that shaped a generation\'s love of Japanese pop culture.',
    longDescription: 'Super Play was a British magazine dedicated to the Super Nintendo, published by Future Publishing from October 1992 to September 1996. In a UK market full of competent multiformat magazines, Super Play distinguished itself through an unusually deep and affectionate focus on Japan. It covered not just the games that reached British shelves but the wider Japanese market — including many role-playing games that were never officially released in the UK or Europe — treating import titles and the Japanese scene as central rather than exotic curiosities.\n\nThat editorial obsession made the magazine a bridge to a culture most of its readers had little access to. Super Play covered the JRPG genre in real depth at a time when few of those games were localised, and, recognising the close ties between Japanese console RPGs and animation, it ran substantial coverage of manga and anime, much of it by the noted UK writer Helen McCarthy. For many British readers in the early-to-mid 1990s, Super Play was a first serious encounter with anime and with Japanese games they might never be able to buy — and it is credited with helping push forward the then-nascent UK market for anime.\n\nVisually the magazine was defined by artist Wil Overton, whose manga-influenced illustrations graced the covers and filled the interior. Overton illustrated every one of Super Play\'s 47 covers and eventually wrote for the magazine as well, giving it a distinctive, hand-drawn Japanese aesthetic that set it apart from the screenshot-heavy design of its rivals and became inseparable from its identity. That house style, combined with a witty, knowledgeable editorial voice, earned the magazine a devotion that has only grown in retrospect.\n\nSuper Play\'s reputation as a legendary 1990s games magazine is secure. It was succeeded in 1997 by N64 Magazine — which carried over staff and Overton as art editor but was far less focused on imports and RPGs — and in 2017 Future produced a one-off Super Play revival to mark the SNES Classic Edition, an act of nostalgia that only underlined how fondly the original is remembered. Its influence lies in having taken Japanese games and culture seriously, and stylishly, for an English-speaking audience, years before doing so became mainstream.',
    notableIssues: [
      'Issue 1 (October 1992) — Wil Overton\'s debut manga-style cover launched the magazine\'s signature look',
      'Its ongoing coverage of unlocalised Japanese RPGs introduced UK readers to games they could not buy',
      'Regular anime and manga features by Helen McCarthy helped seed the UK anime market',
      '2017 one-off revival by Future Publishing timed to the SNES Classic Edition launch',
    ],
    keyFacts: [
      'A Future Publishing SNES magazine, running October 1992 to September 1996',
      'Focused deeply on Japan — import games, unlocalised RPGs, and anime',
      'Wil Overton illustrated all 47 covers in a manga-influenced style',
      'Succeeded by N64 Magazine (1997); given a one-off revival in 2017',
    ],
    keyword: 'Super Play',
  },
  {
    id: 'computer-gaming-world',
    name: 'Computer Gaming World',
    country: 'United States',
    founded: 1981,
    closed: 2006,
    era: '1980s',
    description: 'The first magazine devoted specifically to computer games, founded by Russell Sipe in 1981 — a serious, long-lived US PC-gaming institution that survived the 1983 crash and covered the hobby for a quarter-century.',
    longDescription: 'Computer Gaming World (CGW) was an American magazine that ran from 1981 to 2006 and holds the distinction of being the first publication devoted specifically to computer games. Its founding is a small story of spotting a gap: Russell Sipe, who had left the Southern Baptist Convention ministry in 1979 and was a keen computer-game player, realised in the spring of 1981 that no magazine was dedicated to the pastime. With no publishing experience, he formed Golden Empire Publications that June, found investors, and put out the first issue in November.\n\nSipe chose the name Computer Gaming World — over alternatives like "Computer Games" or the jokier "Kilobaud Warrior" — because he wanted the magazine to do double duty: reviewing games for players while also serving as a trade publication for the young industry. The earliest issues, produced out of Anaheim, California and sold for $2.75, were slim bimonthly booklets of 40 to 50 pages written in a plain, newsletter-like style, and notably included contributions from game designers themselves — figures like Joel Billings of SSI, Dan Bunten of Ozark Software, and Chris Crawford. That closeness to the creators gave CGW an authoritative, insider character from the start.\n\nThe magazine\'s survival was itself significant. It launched at almost the same moment as rivals like Electronic Games and Softline, and it was one of the few game magazines of its era to survive the video-game crash of 1983 that wiped out much of the industry\'s press. That endurance let it grow with the PC-gaming hobby through the 1980s and 1990s into a thick, influential monthly, and in 1993 it was sold to the major publisher Ziff Davis.\n\nComputer Gaming World\'s importance is foundational: it established the very idea of the dedicated games magazine, and it did so for the computer-gaming side of the hobby specifically, cultivating a more serious, analytical tone than much of the console press that followed. Across a 25-year run it chronicled the evolution of PC gaming from the Apple II era to the 3D age, and its longevity made it a rare continuous thread connecting the industry\'s earliest days to its modern form.',
    notableIssues: [
      'Issue 1 (November 1981) — the first issue of the first magazine devoted to computer games',
      'Early issues carried articles by designers such as Chris Crawford, Dan Bunten, and Joel Billings',
      'One of the few games magazines to survive the 1983 video-game crash',
      'Acquired by Ziff Davis in 1993 as PC gaming entered its boom years',
    ],
    keyFacts: [
      'Founded by Russell Sipe in 1981 as the first magazine specifically about computer games',
      'Named to serve as both a review magazine and an industry trade publication',
      'Survived the 1983 crash that killed many contemporaries; ran until 2006',
      'Sold to Ziff Davis in 1993',
    ],
    keyword: 'Computer Gaming World',
  },
  {
    id: 'your-sinclair',
    name: 'Your Sinclair',
    ...
    closed: 1993,
    era: '1980s',
    description: 'A British ZX Spectrum magazine famous for trading dry technical coverage for anarchic, self-mocking humour — a tone that reshaped UK games journalism and fed directly into later titles like Amiga Power.',
    longDescription: 'Your Sinclair was a British magazine covering Sinclair\'s computers — chiefly the ZX Spectrum — published from 1984 to 1993. It began in January 1984 as Your Spectrum under Sportscene Specialist Press (later Dennis Publishing), with the serious, technical bent typical of early home-computer magazines: buying guides, hardware advice, and programming tutorials. In January 1986 it was relaunched and rebranded as Your Sinclair, and with the new name came a deliberate change of character, shifting away from in-depth programming toward games, pop culture, and entertainment aimed at a younger readership.\n\nWhat made Your Sinclair legendary was its tone. Where its contemporaries were earnest, Your Sinclair was funny — often absurdly so. It cultivated a style of juvenile wit, running in-jokes, surreal covers, and playful reader competitions that treated the magazine as much a comedy publication as a computing one. This anarchic voice was a genuine departure in a market that mostly took itself seriously, and it built a strong bond with readers, pushing circulation past 80,000 copies a month by putting entertainment ahead of dry specifications.\n\nThat humour was not merely decoration; it was a philosophy about what games journalism could be. Your Sinclair treated its readers as fellow enthusiasts in on the joke rather than as students to be lectured, and its writers developed a self-aware, irreverent register — happy to mock the magazine itself, the games, and the whole enterprise — that felt fresh and personal. The approach influenced a wave of UK magazines, and many of its writers carried the sensibility forward directly.\n\nThe clearest inheritor was Amiga Power, launched in 1991 as a spiritual successor that adopted the same quirky features, community focus, and comedic voice. Your Sinclair itself ran until 1993, ending with the Spectrum\'s own decline, but its real legacy is stylistic: it helped establish that British games writing could be witty, opinionated, and irreverent, a tone that became a defining characteristic of the UK games press and set it apart from the more straight-faced journalism elsewhere.',
    notableIssues: [
      'Launched January 1984 as Your Spectrum; relaunched as Your Sinclair in January 1986',
      'The post-1986 shift to humour and games over programming defined its identity',
      'Circulation passed 80,000 monthly on the strength of its entertainment-first approach',
      'Its comedic style carried directly into Amiga Power (1991) and the wider UK games press',
    ],
    keyFacts: [
      'A British ZX Spectrum magazine, published 1984–1993',
      'Began as the technical Your Spectrum before rebranding to a games-and-humour focus in 1986',
      'Famous for anarchic, self-mocking wit that reshaped UK games journalism',
      'Directly influenced Amiga Power and a generation of British games writers',
    ],
    keyword: 'Your Sinclair',
  },
];
