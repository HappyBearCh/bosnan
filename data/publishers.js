...
module.exports = [
  ...
  },
  {
    ...
    dissolved: null,
    era: '1978 – present',
    description: 'The company that refused to compromise: SNK sold a home console that was literally arcade hardware, at $649 with $200 cartridges, and never pretended it was for everybody.',
    longDescription: 'SNK traces back to Shin Nihon Kikaku — New Japan Project — established in Osaka by Eikichi Kawasaki, who moved the business into coin-operated video games as that market began its climb, and reorganised it as a stock company in 1978. Through the 1980s SNK was a solid second-tier arcade name on the strength of Ikari Warriors, Athena and Guerrilla War rather than a defining one. What changed that was a decision in 1990 that no other manufacturer was willing to make. The Neo Geo arrived in two forms built on identical hardware. The MVS, or Multi Video System, was an arcade platform whose multi-slot cabinets let an operator stock several games at once and swap them cheaply — a genuinely new commercial proposition for arcade owners, and the reason MVS boards stayed in service for well over a decade. The AES was the same machine in a home case, launched in Japan on 26 April 1990 and in North America that August at $649.99, with cartridges running from roughly $200 upward. Those numbers were not a miscalculation. Every other console of the era shipped a reduced version of the arcade game because the home hardware was cheaper hardware; the Neo Geo\'s proposition was that the cartridge you played at home was the arcade board\'s game, in full, with nothing removed, and the price was what that cost. It was never going to be a mass-market machine and SNK did not build it as one. The catalogue that followed made the company\'s reputation permanent — Fatal Fury, Art of Fighting, Samurai Shodown, the annual King of Fighters series, and Metal Slug from the acquired studio Nazca — even as the finances did not hold. SNK was sold to Aruze in 2000 and went bankrupt in 2001, reconstituting as Playmore, trading as SNK Playmore, and reverting to the SNK name in 2016.',
    notableTitles: [
      'Ikari Warriors (1986)',
      'Athena (1986)',
      'Baseball Stars (1989)',
      'Neo Geo MVS and AES hardware (1990)',
      'Fatal Fury: King of Fighters (1991)',
      'Art of Fighting (1992)',
      'Samurai Shodown (1993)',
      'The King of Fighters series (1994 onward)',
      'Metal Slug (1996)',
      'Neo Geo Pocket Color (1999)',
    ],
    keyFacts: [
      'Grew out of Shin Nihon Kikaku — "New Japan Project" — founded in Osaka by Eikichi Kawasaki and reorganised as a stock company in 1978',
      'The Neo Geo MVS let arcade operators stock several games in one multi-slot cabinet and swap them cheaply',
      'The Neo Geo AES launched in Japan on 26 April 1990 and in North America that August at $649.99',
      'Cartridges ran from around $200 upward — by a wide margin the most expensive console software of the era',
      'Because the AES used the same hardware as the arcade board, home releases were the arcade game rather than conversions',
      'SNK went bankrupt in 2001, was reconstituted as Playmore, traded as SNK Playmore, and reverted to SNK in 2016',
    ],
    keyword: 'SNK',
  },
  {
    ...
    dissolved: 1999,
    era: '1984 – 1999',
    description: 'Two of Activision\'s founders walked out to start Accolade — and then won the court case that made reverse-engineering a games console legal in the United States.',
    longDescription: 'Accolade was founded in San Jose in November 1984 by Alan Miller and Bob Whitehead, who had co-founded Activision five years earlier after leaving Atari. Each man had now walked out of a company twice to start another one, and the pattern was consistent: both departures were about who controls the work. The catalogue that followed was broad rather than deep — Law of the West, The Dam Busters, HardBall!, Mean 18 and, in 1987, Test Drive, which built a long-running series out of the simple proposition that the car should be one you actually wanted to own. Star Control in 1990 earned the company its strongest critical notices, and Bubsy in 1993 its strongest sales. But Accolade\'s permanent significance is a court judgment. Wanting to publish on the Sega Genesis without accepting Sega\'s licensing terms, Accolade\'s engineers disassembled Sega\'s object code, worked out the functional interface a cartridge had to present to boot on the console, and wrote their own games against it, copying none of Sega\'s code into the finished products. Sega sued for copyright and trademark infringement and won at district level. On 20 October 1992 the Ninth Circuit reversed, holding in Sega Enterprises Ltd. v. Accolade, Inc., 977 F.2d 1510 that intermediate copying — disassembling object code in order to read it — is fair use where it is the only way to reach functional elements that copyright does not protect in the first place. That ruling is now foundational software law, cited far outside games; a great deal of interoperability work, emulation included, rests on it. The company itself did not last: Infogrames acquired Accolade in April 1999 for $60 million and renamed it Infogrames North America.',
    notableTitles: [
      'Law of the West (1985)',
      'HardBall! (1985)',
      'The Dam Busters (1985)',
      'Mean 18 (1986)',
      'Test Drive (1987) and the series that followed',
      'Star Control (1990)',
      'Bubsy in Claws Encounters of the Furred Kind (1993)',
    ],
    keyFacts: [
      'Founded in San Jose in November 1984 by Alan Miller and Bob Whitehead, who had co-founded Activision in 1979',
      'Disassembled Sega Genesis object code in order to publish on the console without a licence',
      'The Ninth Circuit ruled for Accolade on 20 October 1992 in Sega Enterprises Ltd. v. Accolade, Inc., 977 F.2d 1510',
      'The court held that intermediate copying is fair use when it is the only way to reach unprotected functional elements',
      'The decision remains a foundation of software interoperability law well beyond video games',
      'Infogrames acquired Accolade in April 1999 for $60 million and renamed it Infogrames North America',
    ],
    keyword: 'Accolade',
  },
  {
    ...
    dissolved: 2001,
    era: '1982 – 2001',
    description: 'Founded after a programmer beat a retired fighter pilot at a flight game by reading its code, then told him he could write a better one in a week.',
    longDescription: 'MicroProse began with a bet made in Las Vegas in 1982. Mutual friends introduced Bill Stealey, a retired military pilot, to Sid Meier, a programmer, on the grounds that both were interested in aviation. Playing the arcade game Red Baron, Meier beat Stealey repeatedly, and then explained why: he had worked out how the game was programmed and could predict what it would do. He added that he could design a better one in a week. It took two months, the game was Hellcat Ace, Stealey sold fifty copies on his first sales call, and the two of them had a company. For most of the 1980s MicroProse was the serious end of the market for military simulation — F-15 Strike Eagle, Silent Service, Gunship, F-19 Stealth Fighter — games with thick manuals and a real expectation that the player would read them. Then Meier\'s design work broadened the company past the cockpit: Sid Meier\'s Pirates! in 1987, Railroad Tycoon in 1990 and Civilization in 1991, which did not so much enter the strategy genre as become it. Success did not translate into stability. Debt accumulated, two arcade machines failed to earn back what they cost, and an initial public offering was used to raise cash. In 1993 Stealey approached Gilman Louie of Spectrum HoloByte and asked him to buy MicroProse outright rather than let it fall to an unknown acquirer; Stealey departed the following year, later summarising the merger as one company with a lot of cash and few products joining another with a lot of products and no cash. Hasbro Interactive acquired the business in 1998, and when Infogrames took over Hasbro Interactive in January 2001, MicroProse ceased to exist.',
    notableTitles: [
      'Hellcat Ace (1982)',
    ...
    keyFacts: [
      'Founded in 1982 by Bill Stealey and Sid Meier, who were introduced in Las Vegas over a shared interest in aviation',
      'Meier beat Stealey repeatedly at Red Baron by analysing its programming, then claimed he could write a better game in a week',
      'That game, Hellcat Ace, took two months and became MicroProse\'s first product',
      'Built its reputation on flight simulators and military strategy before Pirates!, Railroad Tycoon and Civilization broadened it',
      'Stealey approached Spectrum HoloByte in 1993 and asked it to buy the struggling company; he left the following year',
      'Hasbro Interactive acquired MicroProse in 1998, and it ceased to exist when Infogrames took over Hasbro Interactive in January 2001',
    ],
    keyword: 'MicroProse',
  },
];
