...
module.exports = [
  ...
  {
    id: 'out-run-deluxe-cabinet',
    title: 'Out Run Deluxe (Hydraulic Sit-Down)',
    game: 'Out Run',
    manufacturer: 'Sega',
    year: 1986,
    artist: 'Sega AM2 (Yu Suzuki, design)',
    era: '1980s',
    description: 'Not a cabinet with a picture on it — a cabinet that moves. Sega built a motion simulator shaped like a convertible and put a Ferrari, a blonde passenger and a Mediterranean coastline in front of you.',
    longDescription: 'Out Run was designed by Yu Suzuki, who travelled across Europe to gather reference for its stages, and the deluxe cabinet is the reason the game is remembered as an experience rather than a racing title. The sit-down unit is built to resemble the in-game car: you climb into it rather than stand at it. A drive motor and hydraulic system tilt and rock the entire housing in response to what is happening on screen, so that cornering hard leans you into the turn and a crash throws the cabinet — and you — physically sideways. Stereo speakers are mounted behind the driver\'s head, which places Hiroshi Kawaguchi\'s selectable soundtrack (chosen, brilliantly, by pressing buttons on the in-car radio) around the player rather than in front of them.\n\nThe cabinet art follows the same logic. Where most 1986 machines shouted at you with airbrushed monsters, Out Run\'s livery is all sun, coastline, red bodywork and open road — an advertisement for a holiday rather than a game. Sega was not selling a challenge; it was selling a fantasy of leisure that had nothing to do with the arcade\'s usual currency of threat and mastery. The deluxe unit is widely regarded as the definitive way to play the game and remains one of the most sought-after cabinets in collecting.',
    keyFacts: [
      'The entire cabinet moves — a drive motor and hydraulic system tilt and shake it in response to the on-screen car',
      'Designed by Yu Suzuki, who toured Europe personally to gather visual reference for the stages',
      'Stereo speakers sit behind the driver\'s head, surrounding the player with Hiroshi Kawaguchi\'s score',
      'The soundtrack is selected diegetically, by pressing buttons on the car\'s in-game radio',
      'Sold the fantasy of a European coastal drive rather than the arcade\'s usual imagery of danger',
    ],
    notableFor: 'The definitive motion-simulator arcade cabinet, and the one most collectors want',
    sections: [
      {
        title: 'Selling a Holiday, Not a Challenge',
        html: '<p>Every visual and physical decision in the deluxe Out Run cabinet points away from the arcade\'s dominant grammar. There is no monster on the side art, no skull, no explosion, no implied threat. There is a red convertible, a blue sea, and a road going somewhere pleasant. In an arcade full of machines competing to look the most dangerous, an Out Run cabinet looked like a window.</p><p>This was strategically shrewd as well as aesthetically distinctive. Out Run has no lives to lose in the conventional sense and no enemies at all — the antagonist is a clock. That makes it approachable to people who would never queue for Gauntlet or Sinistar, and the cabinet\'s inviting, sun-drenched presentation is doing the work of telling them so before they have read a single instruction.</p>',
      },
      {
        title: 'The Body as an Input',
        html: '<p>Motion cabinets existed before Out Run, but Sega\'s hydraulic unit is the one that made the technique canonical, because the motion is genuinely coupled to the driving model rather than decorative. Taking a corner too fast does not merely display a skid; it leans the housing, and the player\'s inner ear registers the mistake before their eyes do. The cabinet is not a chair the game happens to be shown from — it is a channel through which the simulation reaches the player\'s body.</p><p>That idea is the direct ancestor of everything Sega did in the arcade for the following decade, from After Burner\'s rotating cockpit to the motorbike of Hang-On. It is also, not coincidentally, the thing home ports have never been able to reproduce. You can emulate Out Run\'s code perfectly and still not have the game, because a substantial part of the game was the furniture.</p>',
      },
    ],
  },
  {
    ...
    notableFor: 'The most frightening attract mode in arcade history',
    sections: [
      {
        title: 'A Cabinet That Hunts You',
        html: '<p>Most arcade attract modes are advertisements: here is some gameplay, here is a high-score table, please insert a coin. Sinistar\'s is a threat, delivered in a voice, at volume, to a room full of people who did not ask for it. The design intent is unusually direct — the machine is trying to unnerve you into playing it, and the reason it works is that the thing doing the threatening is not a narrator or an announcer. It is the enemy, speaking in the first person, before you have paid.</p><p>The art and the audio are pulling in the same direction. Almost every other cabinet of the era used its side panels to depict a heroic protagonist, or a scene of action in which the player is winning. Sinistar\'s panels depict the monster, alone, filling the frame. There is no hero on this cabinet, which tells you everything about how the game expects the encounter to go.</p>',
      },
      {
        title: 'The Fear of the Assembling Enemy',
        html: '<p>The genius of Sinistar as a design is that the Sinistar is built in front of you. Enemy workers mine the asteroid field and haul pieces to a construction point, and the player can watch the thing being assembled, piece by piece, in real time, while trying to prevent it — and the game will taunt you as the construction proceeds. When it is complete, it comes alive, announces itself, and hunts.</p><p>That is a horror structure rather than an arcade one, and the cabinet is engineered to support it. The malevolent face on the side art is a promise about what is going to happen. The voice is the countdown. By the time the player hears "Beware, I live!" they have already spent two minutes watching it be born, which is why a game consisting of asteroids and a spaceship is remembered by a generation as genuinely frightening.</p>',
      },
    ],
  },
  {
    id: 'gauntlet-four-player-cabinet',
    title: 'Gauntlet (Four-Player Cabinet)',
    game: 'Gauntlet',
    manufacturer: 'Atari Games',
    year: 1985,
    artist: 'Atari Games (in-house)',
    era: '1980s',
    description: 'A cabinet built for four people to stand shoulder to shoulder — Warrior, Valkyrie, Wizard and Elf, each with their own joystick, their own colour, and their own reason to steal your food.',
    longDescription: 'Gauntlet arrived in October 1985 and was, initially, available only as a dedicated four-player machine. That is the whole design. The cabinet is wide, with four full control positions arrayed across the front, each assigned to one of the game\'s characters: Thor the Warrior, Thyra the Valkyrie, Merlin the Wizard, and Questor the Elf, distinguished by colour and by genuinely different capabilities — Thyra has the strongest armour, Thor the best melee, Questor the greatest speed, Merlin the most powerful magic. The side art carries the four heroes and nothing else, the enemies having been stripped out and replaced with a flat pink background, so the panels read as a party portrait rather than a battle scene.\n\nAtari built and distributed 7,848 units, and released a cut-down two-player variant in June 1986 for operators who could not afford the four-player machine or lacked the floor space for it — which was a real constraint, because a four-position cabinet occupies the footprint of two ordinary uprights and needs standing room for four people in front of it. That physical demand is the reason a Gauntlet machine dominated the room it was in, and the reason it worked: this was one of the first arcade games where the machine\'s shape obliged strangers to cooperate.',
    keyFacts: [
      'Released October 1985 and initially sold only as a dedicated four-player cabinet',
      'Four control positions across the front, one each for Warrior, Valkyrie, Wizard and Elf',
      'The four characters have genuinely different strengths — armour, melee, speed and magic',
      'Atari distributed 7,848 units; a two-player variant followed in June 1986 for smaller venues',
      'The side art shows only the four heroes, with the enemies removed and replaced by a flat pink ground',
    ],
    notableFor: 'The cabinet that made four strangers play a dungeon crawl together',
    sections: [
      {
        title: 'A Machine That Requires a Crowd',
        html: '<p>Almost every arcade cabinet is designed for one person, with a second occasionally tolerated. Gauntlet is designed for four, and the physical consequences of that decision are what make the game famous. Four people standing at one machine is not a private experience; it is a small public event, and it draws a crowd, which draws more players, which fills all four slots again. The cabinet is a social engine.</p><p>Critically, the players are not merely co-located but genuinely interdependent and genuinely in conflict. Food restores health and there is only one plate of it; anybody can eat it, and anybody can shoot it. The famous announcer line — "Wizard needs food, badly" — is addressed to the whole cabinet, and the four humans standing at it have to decide, out loud, what to do about it. Very few games before Gauntlet made a room full of strangers negotiate with each other.</p>',
      },
      {
        title: 'The Coin Slot as a Health Bar',
        html: '<p>Gauntlet\'s commercial design is as ruthless as its cabinet design is generous. Health drains continuously, simply as a function of time, and the only way to top it up beyond what the dungeon provides is to feed the machine another coin. The game therefore never ends in the way an arcade game normally does — you do not lose, you simply run out of money, and the machine will happily keep going for as long as you keep paying.</p><p>Multiplied by four players standing at a single cabinet, that is an extraordinary rate of coin intake, and it explains why operators tolerated a machine with the footprint of two. Gauntlet is one of the clearest cases in arcade history of the business model and the social design reinforcing each other: it is more fun with four people, and four people bleed four times the quarters.</p>',
      },
    ],
  },
];
